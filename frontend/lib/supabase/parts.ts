...
// Pre-sorted by value (benchmark_score/price ratio) - best value first
export const SAMPLE_PARTS = {
  cpu: [
    // Best value CPUs first (sorted by benchmark/price ratio)
  ...
  gpu: [
    // Best value GPUs first (sorted by benchmark/price ratio)
